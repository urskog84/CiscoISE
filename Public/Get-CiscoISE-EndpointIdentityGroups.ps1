function Get-CiscoISE-EndpointIdentityGroups {   
    ...
    Begin {
        $Uri = "https://" + $ISEserver +":" + $ISEport + "/ers/config/endpointgroup"
        $Headers = Get-Headers -Credential $Credential -Accept 'application/vnd.com.cisco.ise.identity.endpointgroup.1.0+xml'
        }
