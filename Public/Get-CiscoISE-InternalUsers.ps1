function Get-CiscoISE-InternalUsers {   
    ...
    Begin {
        $Uri = "https://" + $ISEserver +":" + $ISEport + "/ers/config/internaluser"
        $Headers = Get-Headers -Credential $Credential -Accept 'application/vnd.com.cisco.ise.identity.internaluser.1.0+xml'
        }
