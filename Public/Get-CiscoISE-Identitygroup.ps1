function Get-CiscoISE-Identitygroup {   
    ...
    Begin {
        $Uri = "https://" + $ISEserver +":" + $ISEport + "/ers/config/identitygroup"
        $Headers = Get-Headers -Credential $Credential -Accept 'application/vnd.com.cisco.ise.identity.identitygroup.1.0+xml'
        }
